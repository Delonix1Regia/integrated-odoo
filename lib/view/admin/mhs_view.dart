  ...
  Future<void> _addMahasiswa({Map<String, dynamic>? mahasiswa}) async {
    final newMahasiswa = await showDialog<Map<String, dynamic>>(
      ...
      builder: (BuildContext context) {
        ...
        // final _kategoriInstansiController =
        //     TextEditingController(text: mahasiswa?['kategori_instansi']);
        // final _namaInstansiController =
        //     TextEditingController(text: mahasiswa?['nama_instansi']);
        // final _statusUsahaController =
        //     TextEditingController(text: mahasiswa?['status_usaha']);
        // final _posisiWiraswastaController =
        //     TextEditingController(text: mahasiswa?['posisi_wiraswasta']);
        // final _tingkatUsahaController =
        //     TextEditingController(text: mahasiswa?['tingkat_usaha']);
        // final _jenjangPendidikanController =
        //     TextEditingController(text: mahasiswa?['jenjang_pendidikan']);
              ...
              content: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    FutureBuilder<List<Fakultas>>(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                          ...
                          debugPrint('Fakultas Error: ${snapshot.error}');
                    ...
                    FutureBuilder<List<Prodi>>(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                          ...
                          debugPrint('Prodi Error: ${snapshot.error}');
                          return Text('Error: ${snapshot.error}');
                        } else if (snapshot.hasData) {
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    // if (selectedStatus == 'Bekerja (full time/part time)')
                    //   TextField(
                    //     controller: _namaInstansiController,
                    //     decoration: InputDecoration(labelText: 'Nama Instansi'),
                    //   ),
                    // if (selectedStatus == 'Wiraswasta')
                    //   TextField(
                    //     controller: _statusUsahaController,
                    //     decoration: InputDecoration(labelText: 'Status Usaha'),
                    //   ),
                    // if (selectedStatus == 'Wiraswasta')
                    //   TextField(
                    //     controller: _posisiWiraswastaController,
                    //     decoration: InputDecoration(labelText: 'Posisi Usaha'),
                    //   ),
                    // if (selectedStatus == 'Wiraswasta')
                    //   TextField(
                    //     controller: _tingkatUsahaController,
                    //     decoration: InputDecoration(labelText: 'Tingkat Usaha'),
                    //   ),
                    // if (selectedStatus == 'Melanjutkan Pendidikan')
                    //   TextField(
                    //     controller: _jenjangPendidikanController,
                    //     decoration: InputDecoration(
                    //         labelText: 'Jenjang Pendidikan Lanjut'),
                    //   ),
                    // if (selectedStatus == 'Melanjutkan Pendidikan')
                    //   TextField(
                    //     controller: _kategoriInstansiController,
                    //     decoration: InputDecoration(
                    //         labelText: 'Kategori Instansi Pendidikan'),
                    //   ),
                  ],
                ),
              ),
                ...
                TextButton(
                  onPressed: () {
                    final newMahasiswaData = {
                      ...
                      // 'kategori_instansi': _kategoriInstansiController.text,
                      // 'nama_instansi': _namaInstansiController.text,
                      // 'status_usaha': _statusUsahaController.text,
                      // 'posisi_wiraswasta': _posisiWiraswastaController.text,
                      // 'tingkat_usaha': _tingkatUsahaController.text,
